...
import { AppState, AppProps } from "../interface/routes/App.interface";
...
export default class extends React.PureComponent<AppProps, AppState> {
  constructor(props: AppProps) {
    ...
    this.state = {
      navHeight: Nav.getHeight(browserType),
      sidePanelWidth: SidePanel.getWidth(browserType),
      screen: getScreenType()
    };
  }
  public getBrowserType = (): "mobile" | "desktop" => {
    var check = false;
    (function(a) {
      if (
    ...
    if (check === true) return "mobile";
    else return "desktop";
  };
  public setScreenSize = () => {
    if (getScreenType() === this.state.screen) return;
    else {
      this.setState({ ...this.state, screen: getScreenType() });
    }
  };
    ...
    return (
      ...
      >
        ...
        <MainPanel
          ...
          browser={this.getBrowserType()}
          marginLeft={0}
          marginTop={this.state.navHeight}
          screen={this.state.screen}
        />
      </App>
    );
